...
export default function AdsterraNativeBanner() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-6 px-4">
      <div className="glass-panel-light rounded-2xl p-4 border border-emerald-200/80 shadow-sm flex flex-col items-center justify-center bg-white/90 backdrop-blur-md transition-all duration-300 min-h-[110px]">
        <div className="w-full flex items-center justify-between pb-2 mb-2 border-b border-slate-100/80">
          <div className="text-[11px] font-semibold text-slate-600 flex items-center gap-1.5">
            ...
            <span>☕ Quảng cáo giúp duy trì Server miễn phí (Cảm ơn bạn đã thông cảm & ủng hộ! 🙏)</span>
          </div>
          <span className="text-[10px] font-mono text-slate-400 hidden sm:inline">YT Downloader Pro</span>
        </div>
